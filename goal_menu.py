...
class Goal_Frame(tk.Frame):
    def __init__(self, root = None):
        ...
        title = tk.Label(self, text = "Add/Manage Goal", bg = "#BEBEBE", fg = "#000000", font = "Averia Serif Libre")
        title.grid(row = 0, column = 0, columnspan = 5, pady = (10, 20))
    ...
    def display_info(self):
        ...
        for j, g in enumerate(self.fetched_goals):
            ...
            name_label = tk.Label(self, text = g[1], bg = "#6FFF6F", fg = "#000000", font = "Averia Serif Libre", bd = 2)
            ...
            # Show goal amounts
            amount_label = tk.Label(self, text = g[2], bg = "#0E5200", fg = "#FFFFFF", font = "Averia Serif Libre", bd = 2)
            ...
            edit_button = tk.Button(self, text = "Edit", bg = "#01C64C", cursor = "hand2",
                                activebackground = "#01C64C", command = lambda i = goal_id: self.on_edit(i))
    ...
    def instruction_label(self):
        ...
        instruction = tk.Label(self, text = f"{bullet_char} Click on \"Edit\" to change the name or amount for your goal."
                               f"\n{bullet_char}Click on the trash icon to delete a goal.", 
                                bg = "#BEBEBE", fg = "#000000", font = "Averia Serif Libre", bd = 2, justify = tk.LEFT)
        row_span = max(len(self.fetched_goals), 1)
        instruction.grid(row = 2, column = 5, rowspan = row_span, padx = 20, pady = 20, sticky = "nsew")

    def new_goal_button(self):
        new_row = len(self.fetched_goals) + 1
        new = tk.Button(self, text = "Add New Goal", font = "Averia Serif Libre", bg = "#000000", cursor = "hand2",
                        fg = "#6FFF6F", activebackground = "#000000", command = lambda: Add_Goal_Frame(self.root, self)) # Pass self to refresh after adding
    ...
    def main_menu_button(self):
        ...
        main_menu = tk.Button(self, text = "Main Menu", font = "Averia Serif Libre", bg = "#000000", cursor = "hand2",
                        fg = "#6FFF6F", activebackground = "#000000", command = self.back_to_main_menu)
...
class Add_Goal_Frame(tk.Frame):
    def __init__(self, root, parent_frame): # parent_frame is Goal_Frame
        ...
        super().__init__(self.window, width=300, height=200)
        self.root = root
        ...
        title = tk.Label(self, text = "Add New Goal", bg = "#919191", fg = "#000000", font = "Averia Serif Libre")
        title.grid(row = 0, column = 0, columnspan = 2, pady = (10, 20), sticky= "nsew")

        self.goal_fields()
        self.button_add() 
        self.cancel_button()
        self.grid_columnconfigure(1, weight = 1) # In case the window is resized, this ensure column 1 expands to fill the width of window

    def goal_fields(self):
        name_label = tk.Label(self, text = "Goal Name:", bg = "#919191", fg = "#000000", font = "Averia Serif Libre")
        name_label.grid(row = 1, column = 0, padx = 10, pady = 10, sticky = "nsew")
        self.name_entry = tk.Entry(self)
        self.name_entry.grid(row = 1, column = 1, font = "Averia Serif Libre",padx = 10, pady = 10, sticky = "nsew")

        amount_label = tk.Label(self, text = "Goal Amount:", bg = "#919191", fg = "#000000", font = "Averia Serif Libre")
        amount_label.grid(row = 2, column = 0, padx = 10, pady = 10, sticky = "nsew")
        self.amount_entry = tk.Entry(self)
        self.amount_entry.grid(row = 2, column = 1, font = "Averia Serif Libre", padx = 10, pady = 10, sticky = "nsew")

        self.grid_columnconfigure(1, weight = 1)

    def button_add(self):
        add_button = tk.Button(self, text = "Add Goal", font = "Averia Serif Libre", bg = "#919191", 
                               cursor = "hand2", activebackground = "#919191", command = self.on_add)
        add_button.grid(row = 3, column = 0, padx = 20, pady = 20)
    
    def cancel_button(self):
        cancel_button = tk.Button(self, text = "Cancel", font = "Averia Serif Libre", bg = "#919191", 
                                  cursor = "hand2", activebackground = "#919191", command = self.window.destroy)
        cancel_button.grid(row = 3, column = 1, padx = 20, pady = 20)
...
class Edit_Goal_Frame(tk.Frame):
    def __init__(self, root, parent_frame, goal_id):
        ...
        title = tk.Label(self, text = "Edit Goal", bg = "#919191", fg = "#000000", font = "Averia Serif Libre")
        title.grid(row = 0, column = 0, columnspan = 2, pady = (10, 20), sticky= "nsew")
    ...
    def display_current_goal(self):
        ...
        # Display current goal name and amount
        current_name_label = tk.Label(self, text = "Current name:", bg = "#919191", fg = "#000000", font = "Averia Serif Libre")
        current_name_label.grid(row = 1, column = 0, padx = 10, pady = 10, sticky = "nsew")
        current_name = tk.Label(self, text = current_name, bg = "#919191", fg = "#000000", font = "Averia Serif Libre", bd = 2)
        current_name.grid(row = 1, column = 1, padx = 10, pady = 10, sticky = "nsew")

        current_amount_label = tk.Label(self, text = "Current amount:", bg = "#919191", fg = "#000000", font = "Averia Serif Libre", bd = 2)
        current_amount_label.grid(row = 2, column = 0, padx = 10, pady = 10, sticky = "nsew")
        current_amount = tk.Label(self, text = current_amount, bg = "#919191", fg = "#000000", font = "Averia Serif Libre", bd = 2)
        current_amount.grid(row = 2, column = 1, padx = 10, pady = 10, sticky = "nsew")

    def new_goal_fields(self):
        # New goal name
        new_name_label = tk.Label(self, text = "New name:", bg = "#919191", fg = "#000000", font = "Averia Serif Libre")
        new_name_label.grid(row = 3, column = 0, padx = 10, pady = 10, sticky = "nsew")
        self.new_name_entry = tk.Entry(self)
        self.new_name_entry.insert(0, self.current_goal_data[1])
        self.new_name_entry.grid(row = 3, column = 1, font = "Averia Serif Libre",padx = 10, pady = 10, sticky = "nsew")

        # New goal amount
        new_amount_label = tk.Label(self, text = "New amount:", bg = "#919191", fg = "#000000", font = "Averia Serif Libre")
        new_amount_label.grid(row = 4, column = 0, padx = 10, pady = 10, sticky = "nsew")
        self.new_amount_entry = tk.Entry(self)
        self.new_amount_entry.insert(0, self.current_goal_data[2])
        self.new_amount_entry.grid(row = 4, column = 1, font = "Averia Serif Libre", padx = 10, pady = 10, sticky = "nsew")

    def button_save(self):
        save_button = tk.Button(self, text = "Save", font = "Averia Serif Libre", bg = "#919191", 
                               cursor = "hand2", activebackground = "#919191", command = self.on_save)
        save_button.grid(row = 5, column = 0, padx = 20, pady = 20, sticky = "nsew")
    
    def cancel_button(self):
        cancel_button = tk.Button(self, text = "Cancel", font = "Averia Serif Libre", bg = "#919191", 
                                  cursor = "hand2", activebackground = "#919191", command = self.window.destroy)
        cancel_button.grid(row = 5, column = 1, padx = 20, pady = 20, sticky = "nsew")
